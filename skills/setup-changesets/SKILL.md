...
description: Set up @changesets/cli in a repo with GitHub Actions automation, worktree-safe configuration, and optional Cloudflare deploy triggers. Use when user wants to add changesets, set up versioning, automate changelogs, or mentions "changesets".
---
