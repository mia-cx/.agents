...
This skill uses Playwright directly — it does **not** need a local dev server. The `webapp-testing` skill's `with_server.py` helper is for local testing; this skill hits live URLs.
