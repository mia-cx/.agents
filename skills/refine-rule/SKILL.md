...
Always-loaded files pay their cost every session; prune hardest here. Apply [agent-copy](../agent-copy/SKILL.md) (Read it first if not already loaded). Checks specific to rule/memory files:
...
- **<50 lines per section** — longer is sediment.
