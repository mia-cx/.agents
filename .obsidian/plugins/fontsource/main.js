...
var PQueue = class extends import_index.default {
  ...
  async add(function_, options = {}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        try {
          ...
          if (options.signal) {
            operation = Promise.race([
              operation,
              __privateMethod(this, _throwOnAbort, throwOnAbort_fn).call(
                this,
                options.signal,
              ),
            ]);
      ...
      this.emit("add");
      __privateMethod(this, _tryToStartAnother, tryToStartAnother_fn).call(
        this,
      );
    });
  }
  ...
  */
  ...
  async onSizeLessThan(limit) {
    ...
    await __privateMethod(this, _onEvent, onEvent_fn).call(
      this,
      "next",
    ...
    if (delay < 0) {
      ...
      if (__privateGet(this, _timeoutId) === void 0) {
        __privateSet(
          ...
          _timeoutId,
          setTimeout(() => {
            __privateMethod(this, _onResumeInterval, onResumeInterval_fn).call(
              this,
            );
          }, delay),
        );
...
var fetchMetadata = async (id) => {
  const metadata = await (0, import_obsidian.requestUrl)(
          ...
          button.onClick(async () => {
            ...
            try {
              ...
              new import_obsidian3.Notice(
                `Unable to delete ${font.id}.css from Vault.`,
              );
            }
          });
        });
