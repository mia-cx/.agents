...
var EventHelper = class {
  ...
  async handleEvents() {
    const debouncedFileModified = (0, import_obsidian.debounce)(
      async (file) => {
...
var FileHelper = class {
  ...
  countEmbeds(metadata) {
    var _a, _b;
    return (_b =
      (_a = metadata == null ? void 0 : metadata.embeds) == null
        ? void 0
        : _a.length) != null
      ? _b
      : 0;
  ...
  countLinks(metadata) {
    var _a, _b;
    return (_b =
      (_a = metadata == null ? void 0 : metadata.links) == null
        ? void 0
        : _a.length) != null
      ? _b
      : 0;
  ...
  async setCounts(counts, file, startNewSession) {
    ...
    const existingSession =
      (_a = counts[file.path]) == null ? void 0 : _a.sessionStart;
    counts[file.path] = {
    ...
    if (this.settings.pageCountType === "ByWords" /* ByWords */) {
      ...
      this.settings.pageCountType === "ByChars" /* ByChars */ &&
    ...
    Object.assign(counts[file.path], {
      ...
      aliases: (0, import_obsidian2.parseFrontMatterAliases)(
        metadata == null ? void 0 : metadata.frontmatter,
      ),
  ...
  trimFrontmatter(content, metadata) {
    ...
    if (hasFrontmatter) {
      const frontmatterPos =
        metadata.frontmatterPosition || metadata.frontmatter.position;
      meaningfulContent =
  ...
  shouldCountFile(file, metadata) {
    ...
    const tags = (0, import_obsidian2.getAllTags)(metadata).map((tag) =>
      tag.toLowerCase(),
    );
    if (
      tags.length &&
...
var NodeLabelHelper = class {
  ...
  getNodeLabel(counts) {
    ...
    return countTypes
      .filter((ct) => ct.$countType !== "none" /* None */)
    ...
    switch (config.$countType) {
      ...
      case "pagedecimal" /* PageDecimal */:
        return this.getBasicCountString({
          ...
          noun: "page",
          abbreviatedNoun:
            COUNT_TYPE_DEFAULT_SHORT_SUFFIXES["pagedecimal" /* PageDecimal */],
          abbreviateDescriptions,
          customSuffix: config.customSuffix,
        });
      case "linebreak" /* Linebreak */:
        return this.getBasicCountString({
          ...
          noun: "line",
          abbreviatedNoun:
            COUNT_TYPE_DEFAULT_SHORT_SUFFIXES["linebreak" /* Linebreak */],
          abbreviateDescriptions,
          customSuffix: config.customSuffix,
        });
      ...
      case "character" /* Character */: {
        ...
        return this.getBasicCountString({
          ...
          noun: "character",
          abbreviatedNoun:
            COUNT_TYPE_DEFAULT_SHORT_SUFFIXES["character" /* Character */],
          abbreviateDescriptions,
          customSuffix: config.customSuffix,
        });
      }
      ...
      case "embed" /* Embed */:
        ...
        return this.getBasicCountString({
          ...
          noun: "embed",
          abbreviatedNoun:
            COUNT_TYPE_DEFAULT_SHORT_SUFFIXES["embed" /* Embed */],
          abbreviateDescriptions,
          customSuffix: config.customSuffix,
        });
      case "alias" /* Alias */:
      ...
      case "created" /* Created */: {
        ...
        const cDate = (0, import_obsidian3.moment)(counts.createdDate).format(
      ...
      case "modified" /* Modified */: {
        ...
        const uDate = (0, import_obsidian3.moment)(counts.modifiedDate).format(
          this.settings.momentDateFormat || "YYYY/MM/DD",
        );
        if (config.customSuffix !== null) {
      ...
      case "frontmatterKey" /* FrontmatterKey */: {
        ...
        const value =
          (_b = counts == null ? void 0 : counts.frontmatter) == null
            ? void 0
            : _b[config.frontmatterKey];
      ...
      case "tracksession" /* TrackSession */: {
        ...
        const quantity = this.getSessionQuantity(
          counts,
          config.$sessionCountType,
        );
        if (config.customSuffix !== null) {
  ...
  getSessionQuantity(counts, $countType) {
    switch ($countType) {
      case "word" /* Word */:
        return NumberFormatDefault.format(
          Math.ceil(counts.wordCount - counts.sessionStart.wordCount),
        );
      case "page" /* Page */:
        return NumberFormatDefault.format(
          Math.ceil(counts.pageCount - counts.sessionStart.pageCount),
        );
      case "pagedecimal" /* PageDecimal */:
        return NumberFormatDecimal.format(
          counts.pageCount - counts.sessionStart.pageCount,
        );
      case "linebreak" /* Linebreak */:
        return NumberFormatDefault.format(
          counts.newlineCount - counts.sessionStart.newlineCount,
        );
      case "note" /* Note */:
        return NumberFormatDefault.format(
          counts.noteCount - counts.sessionStart.noteCount,
        );
      case "character" /* Character */: {
        const characterCount =
          this.settings.characterCountType ===
        ...
        return NumberFormatDefault.format(
          characterCount - startingCharacterCount,
        );
      }
    }
  }
...
var overwriteInvalidCountTypes = (saved) => {
  var _a;
  if (
    !((_a = saved == null ? void 0 : saved.settings) == null
      ? void 0
      : _a.countType)
  ) {
    return;
  ...
  for (const field of fieldsToCheck) {
    if (!COUNT_TYPES.includes(saved.settings[field])) {
      saved.settings[field] =
        field === "countType" ? "word" /* Word */ : "none" /* None */;
    }
  }
  return saved;
};
var migrateToCountConfigurationObject = (saved) => {
  ...
  (_d = settings.folderCountConfig) != null
    ? _d
  ...
  (_e = settings.folderCountConfig2) != null
    ? _e
  ...
  (_f = settings.folderCountConfig3) != null
    ? _f
  ...
  (_g = settings.rootCountConfig) != null
    ? _g
  ...
  (_h = settings.rootCountConfig2) != null
    ? _h
  ...
  (_i = settings.rootCountConfig3) != null
    ? _i
...
var NovelWordCountSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  renderNoteSettings(containerEl) {
    ...
    new import_obsidian4.Setting(containerEl)
      ...
      .addDropdown((drop) => {
        drop
          .addOption("inline" /* Inline */, "Inline")
          .addOption("right" /* Right */, "Right-aligned")
          .addOption("below" /* Below */, "Below")
  ...
  renderAdvancedSettings(containerEl) {
    ...
    if (this.plugin.settings.showAdvanced) {
      ...
      new import_obsidian4.Setting(containerEl)
        ...
        .addSlider((slider) => {
          slider
            ...
            .onChange(
              (0, import_obsidian4.debounce)(opacityChanged.bind(this), 500),
            );
        });
          ...
          txt
            ...
            .onChange(
              (0, import_obsidian4.debounce)(
                includePathsChanged.bind(this, txt),
                1e3,
              ),
            );
        });
      ...
      new import_obsidian4.Setting(containerEl)
        ...
        .addDropdown((drop) => {
          drop
            .addOption("AllCharacters" /* StringLength */, "All characters")
            .addOption(
              "ExcludeWhitespace" /* ExcludeWhitespace */,
              "Exclude whitespace",
            )
      ...
      new import_obsidian4.Setting(containerEl)
        ...
        .addDropdown((drop) => {
          drop
            .addOption("ByWords" /* ByWords */, "Words per page")
            .addOption("ByChars" /* ByChars */, "Characters per page")
      ...
      new import_obsidian4.Setting(containerEl)
        ...
        .addText((txt) => {
          txt
            ...
            .onChange(
              (0, import_obsidian4.debounce)(
                wordsPerMinuteChanged.bind(this, txt),
                1e3,
              ),
            );
        });
      ...
      new import_obsidian4.Setting(containerEl)
        ...
        .addText((txt) => {
          txt
            ...
            .onChange(
              (0, import_obsidian4.debounce)(
                charsPerMinuteChanged.bind(this, txt),
                1e3,
              ),
            );
        });
      ...
      new import_obsidian4.Setting(containerEl)
        ...
        .addText((txt) => {
          txt
            ...
            .onChange(
              (0, import_obsidian4.debounce)(
                dateFormatChanged.bind(this, txt),
                1e3,
              ),
            );
        });
...
var NovelWordCountPlugin = class extends import_obsidian5.Plugin {
  constructor(app, manifest) {
    ...
    this.saveSettingsDebounced = (0, import_obsidian5.debounce)(
      this.saveSettings,
      this.FIVE_MINUTES,
      false,
    );
  ...
  */
  ...
  async updateDisplayedCounts(file = null) {
    ...
    if (
      !hasMobileDrawer &&
      ((_a = fileExplorerView == null ? void 0 : fileExplorerView.headerDom) ==
      null
        ? void 0
        : _a.navButtonsEl)
    ) {
