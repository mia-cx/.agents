...
function v4(options, buf, offset) {
  ...
  if (
    ((rnds[6] = (rnds[6] & 15) | 64), (rnds[8] = (rnds[8] & 63) | 128), buf)
  ) {
    offset = offset || 0;
  ...
  DividerPlugin = class extends import_obsidian.Plugin {
    ...
    async loadSettings() {
      ...
      ((this.settings = Object.assign({}, DEFAULT_SETTINGS, data)),
        this.settings.dividers || (this.settings.dividers = {}));
    }
    /**
     ...
     */
    async versionCheck() {
      let localVersion = "1.1.1",
        stableVersion = await (0, import_obsidian.requestUrl)(
          "https://raw.githubusercontent.com/andrewmcgivery/obsidian-ribbon-divider/main/package.json",
        ).then(async (res) => {
          if (res.status === 200) return (await res.json).version;
        }),
      ...
      (localVersion == null ? void 0 : localVersion.indexOf("beta")) !== -1
        ? localVersion !== betaVersion &&
    ...
    async renderDivider(divider) {
      if (document.body.hasClass("is-phone")) return;
    ...
    async removeDivider(dividerId) {
      (delete this.settings.dividers[dividerId],
        this.saveSettings(),
        this.dividerElements[dividerId] &&
  ...
  DividerSettingTab = class extends import_obsidian.PluginSettingTab {
    ...
    display() {
      ...
      (Object.keys(this.plugin.settings.dividers).forEach((dividerId) => {
        ...
        new import_obsidian.Setting(dividersContainerEl)
          .setName("Divider")
